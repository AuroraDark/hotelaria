...
<%
    ...
    if(sucesso != null){
        out.write("<div class=\"centralizar\"><p class=\"sucesso\">Check-out realizado com sucesso!</p></div>");
    }
...
%>
<form name="frmCReserva" action="ConsultarReservaCheckout">
    <h1>Fazer Check-out</h1>
...
<% if(request.getAttribute("codReserva")!=null) {
    if(request.getAttribute("checkin").equals(true)){
        if(request.getAttribute("checkout").equals(false)){
%>
...
<section class="centralizar">
    <table border="0" cellspacing="0" cellpadding="0" id="tabela">
        ...
        <tr>
            ...
            <td><a href="checkout?codReserva=<%=request.getAttribute("codReserva")%>"
               class="bttblue">Check-out</a></td>
        </tr>
        </tbody>
    </table>
</section>
...
<%}else {
    out.write("<div class=\"centralizar\"><p class=\"erro\">Check-out já foi realizado para esta reserva.</p></div>"); }
        }else {
        out.write("<div class=\"centralizar\"><p class=\"erro\">Check-in precisa ser realizado antes do Check-out.</p></div>"); }
}%>
</body>
</html>
