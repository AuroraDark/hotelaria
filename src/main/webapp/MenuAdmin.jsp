...
<div class="menu">
    <section class="cards">
        <a href="cadastroUsuario.jsp" class="card"><img src="assets/add-user.png" alt="sino"><p>Cadastrar Usuário</p></a>
        <a href="listarUsuarios" class="card"><img src="assets/user.png" alt="sino"><p>Alterar Usuário</p></a>
